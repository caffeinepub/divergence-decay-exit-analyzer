...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ["Inter", "BricolageGrotesque", "system-ui", "sans-serif"],
      ...
      boxShadow: {
        ...
        "glow-teal": "0 0 20px rgba(0,194,199,0.2)",
      ...
      keyframes: {
        ...
        "pulse-teal": {
          "0%, 100%": { boxShadow: "0 0 6px rgba(0,194,199,0.3)" },
          "50%": { boxShadow: "0 0 18px rgba(0,194,199,0.6)" },
        },
      },
      animation: {
